...
ifneq ($(ATLANTIS_BUILD),)
include vendor/atlantis/config/BoardConfigAtlantis.mk
endif
...
ifneq ($(ATLANTIS_BUILD),)
ifneq ($(wildcard device/atlantis/sepolicy/common/sepolicy.mk),)
## We need to be sure the global selinux policies are included
## last, to avoid accidental resetting by device configs
$(eval include device/atlantis/sepolicy/common/sepolicy.mk)
endif
endif
